(function() {
	...
	window.fullScreenTarget;
	window.autoResizeFullScreen;
	...
	tinymce.create('tinymce.plugins.SSButtons', {
		...
		init : function(ed, url) {
			...
			ed.on('FullscreenStateChanged', function(e) {
				fullScreenTarget = e;
				window.autoResizeFullScreen(window.fullScreenTarget);
			});

			tinymce.DOM.bind(window, 'resize', function(e){ window.autoResizeFullScreen(window.fullScreenTarget); });
